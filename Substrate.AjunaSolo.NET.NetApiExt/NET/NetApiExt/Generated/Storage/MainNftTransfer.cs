...
namespace Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class NftTransferStorage
    {
        ...
        public async Task<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_ajuna_nft_transfer.pallet.EnumNftStatus> NftStatuses(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.primitive_types.H256> key, string blockhash, CancellationToken token)
        {
            ...
            var result = await _client.GetStorageAsync<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_ajuna_nft_transfer.pallet.EnumNftStatus>(parameters, blockhash, token);
            return result;
        }
    }
