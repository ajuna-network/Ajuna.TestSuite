...
namespace Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class SudoStorage
    {
        ...
        ///  The `AccountId` of the sudo key.
        /// </summary>
        public async Task<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> Key(string blockhash, CancellationToken token)
        {
    ...
    public sealed class SudoCalls
    {
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(13, "Sudo", 4, "remove_key", byteArray.ToArray());
        }
    }
