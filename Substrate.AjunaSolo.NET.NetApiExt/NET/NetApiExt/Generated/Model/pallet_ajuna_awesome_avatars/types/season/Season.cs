...
namespace Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.season
{
    ...
    /// <summary>
    /// >> 70 - Composite[pallet_ajuna_awesome_avatars.types.season.Season]
    /// </summary>
    ...
    public sealed class Season : BaseType
    {
        ...
        /// >> tiers
        /// </summary>
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT4 Tiers { get; set; }
        /// <summary>
        /// >> single_mint_probs
        /// </summary>
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT5 SingleMintProbs { get; set; }
        /// <summary>
        /// >> batch_mint_probs
        /// </summary>
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT5 BatchMintProbs { get; set; }
        /// <summary>
        /// >> base_prob
        /// </summary>
        ...
        /// >> trade_filters
        /// </summary>
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6 TradeFilters { get; set; }
        /// <summary>
        /// >> fee
        /// </summary>
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.fee.Fee Fee { get; set; }
        /// <summary>
        /// >> mint_logic
        /// </summary>
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.avatar.EnumLogicGeneration MintLogic { get; set; }
        /// <summary>
        /// >> forge_logic
        /// </summary>
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.avatar.EnumLogicGeneration ForgeLogic { get; set; }
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            Tiers = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT4();
            Tiers.Decode(byteArray, ref p);
            SingleMintProbs = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT5();
            SingleMintProbs.Decode(byteArray, ref p);
            BatchMintProbs = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT5();
            ...
            TradeFilters = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6();
            TradeFilters.Decode(byteArray, ref p);
            Fee = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.fee.Fee();
            Fee.Decode(byteArray, ref p);
            MintLogic = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.avatar.EnumLogicGeneration();
            MintLogic.Decode(byteArray, ref p);
            ForgeLogic = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.avatar.EnumLogicGeneration();
